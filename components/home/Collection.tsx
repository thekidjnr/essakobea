    ...
    <section id="collection" className="bg-mist py-28 md:py-36">
      <div className="px-6 md:px-16 max-w-[1400px] mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
          ...
          <Reveal className="col-span-1 md:row-span-2 group">
            <Link href={`/shop/${products[0].id}`} className="block h-full">
          ...
          {products.slice(1).map((product, i) => (
            <Reveal key={product.id} delay={(i + 1) * 80} className="col-span-1 group">
